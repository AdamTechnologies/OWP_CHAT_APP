...
// export const BASE_URL = "http://3.6.123.80:5000/";
...
export const S3_BUCKET_NAME = 'adamtechngnnologies';
export const AWS_ACCESS_KEY = 'AKIA6GYMVS42Q26GMNSR';
export const AWS_SECRET_ACCESS_KEY = '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';
export const AWS_S3_REGION = 'ap-south-1'; // eg. ap-south-1
